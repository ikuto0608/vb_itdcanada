Public Class Assignment2
    ...
    Private Sub btnReserve_Click(sender As Object, e As EventArgs) Handles btnReserve.Click
        ...
        If isBusinessSeat(seatNumber) Then
            allBusinessSeatsDictionary(dtpReservedAt.Value)(seatNumber) = {tbxFirstName.Text, tbxLastName.Text}
            setReserveSeat(seatNumber)
            MsgBox("You reserved Business seat: " & seatNumber)
        End If

        If isEconomySeat(seatNumber) Then
            allEconomySeatsDictionary(dtpReservedAt.Value)(seatNumber) = {tbxFirstName.Text, tbxLastName.Text}
            setReserveSeat(seatNumber)
    ...
    Private Sub btnCancel_Click(sender As Object, e As EventArgs) Handles btnCancel.Click
        Dim seatNumber = tbxSeat.Text
        If isBusinessSeat(seatNumber) Then
            allBusinessSeatsDictionary(dtpReservedAt.Value)(seatNumber) = {"", ""}
            setEmptySeat(seatNumber)
            MsgBox("You canceled Business seat: " & seatNumber)
        End If

        If isEconomySeat(seatNumber) Then
            allEconomySeatsDictionary(dtpReservedAt.Value)(seatNumber) = {"", ""}
            setEmptySeat(seatNumber)
    ...
    Private Sub changeDisplay()
        For x As Integer = 0 To 4
            For y As Integer = 0 To 3
                If isEpmtySeat(allBusinessSeatsDictionary(dtpReservedAt.Value)(SEAT_ALPHABET(y) & (x + 1))) Then
        ...
        For x As Integer = 0 To 29
            For y As Integer = 0 To 9
                If isEpmtySeat(allEconomySeatsDictionary(dtpReservedAt.Value)(SEAT_ALPHABET(y) & (x + 1 + 5))) Then
